...
export const variantStyles = {
  ...
  outline: {
    slate:
      'ring-slate-200 text-slate-700 dark:text-slate-200 ring-slate-300 dark:ring-red-500 hover:text-slate-900 hover:ring-slate-600 active:bg-slate-100 active:text-slate-600 focus-visible:outline-blue-600 focus-visible:ring-slate-300',
    white:
